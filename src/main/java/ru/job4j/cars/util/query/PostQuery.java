...
public class PostQuery {
    ...
    public static final String FROM_POST_WHERE_CAR_MODEL_BRAND_IS =
            "%s %s".formatted(FROM_POST, WHERE_CAR_MODEL_BRAND_IS);
    private static final String WHERE_ID_IS = "WHERE id = :id";
    public static final String FROM_POST_WHERE_ID_IS = "%s %s".formatted(FROM_POST, WHERE_ID_IS);
    private static final String ORDER_BY_CREATED_ASC = "ORDER BY p.created ASC";
    public static final String FROM_POST_ORDER_BY_CREATED_ASC =
            "%s %s".formatted(FROM_POST, ORDER_BY_CREATED_ASC);
    ...
    public static final String FROM_POST_WHERE_CREATED_MORE_THAN_DATE_ORDER_BY_CREATED_ASC =
            "%s %s %s".formatted(FROM_POST, WHERE_CREATED_MORE_THAN_DATE, ORDER_BY_CREATED_ASC);
    ...
    public static final String FROM_POST_WHERE_PHOTO_IS_NOT_NULL_ORDER_BY_CREATED_ASC =
            "%s %s %s".formatted(FROM_POST, WHERE_PHOTO_IS_NOT_NULL, ORDER_BY_CREATED_ASC);
}
