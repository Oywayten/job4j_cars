...
public class BodyTypeQuery {
    ...
    public static final String FROM_BODY_ORDER_BY_NAME_ASC = String.format("%s %s", FROM_BODY, ORDER_BY_NAME_ASC);
    private static final String WHERE_ID_IS = "WHERE id = :bodyTypeId";
    public static final String FROM_BODY_TYPE_WHERE_ID_IS = String.format("%s %s", FROM_BODY, WHERE_ID_IS);
}
